...
const getType = function(obj:any):number{
...
export const perfdiff = function*(o1:any, o2:any):Generator<Diffp,void,void>{
    const t1 = getType(o1);
    const t2 = getType(o2);
    if(t1 !== t2 || (t1 === OTHER && o1 !== o2)){
        //different
...
export const perfdiff2 = function*(o1:any,o2:any):Generator<Diff,void,void>{
    const t1 = getType(o1);
    const t2 = getType(o2);
    if(t1 !== t2 || (t1 === OTHER && o1 !== o2)){
        //different
