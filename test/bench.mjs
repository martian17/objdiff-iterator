...
import { objdiff,perfdiff,perfdiff2 } from "../dist/index.js";
...
async function benchmark(name, obj, newObj, exclude = []) {
	const benchmarks = {
		...
		microdiff: () => microdiff(obj, newObj),
                "objdiff-iterator": ()=>[...objdiff(obj,newObj)],
                "objdiff-iterator*": ()=>[...perfdiff(obj,newObj)],
                "objdiff-iterator**": ()=>[...perfdiff2(obj,newObj)]
	};
	let times = {};
...
//benchmark("Large Object no difference", largeObj, Object.fromEntries(Object.entries(largeObj)));
